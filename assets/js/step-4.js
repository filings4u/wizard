...
window.renderWizardStep4=function(){
 ...
 function recalc(){
   ...
   const t=document.getElementById("step4-order-total");
   if(t)t.textContent=w.money(total);
   w.persist();
 }
