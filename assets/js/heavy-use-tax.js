...
window.formRegistry = window.formRegistry || {};
if (window.formRegistry['heavy-use-tax-2290-form-master']) window.formRegistry['heavy-use-tax-form-master'] = window.formRegistry['heavy-use-tax-2290-form-master'];
if (window.formRegistry['heavy-use-tax-2290-part1-validation']) window.formRegistry['heavy-use-tax-validation-engine'] = window.formRegistry['heavy-use-tax-2290-part1-validation'];
